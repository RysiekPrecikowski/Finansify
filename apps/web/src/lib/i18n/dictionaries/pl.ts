...
export const pl = {
  ...
  // patrz `lib/allocation/demo-allocation.ts`.
  allocation: {
    title: 'Skład i rebalans',
    composition: { title: 'Skład', subtitle: 'udział w wartości' },
    dimensions: {
      class: 'Klasa aktywów',
      currency: 'Waluta',
      account: 'Konto',
    ...
    pickDimension: 'Wybierz wymiar podziału',
    concentration: {
      title: 'Koncentracja',
      subtitle: 'pięć największych pozycji',
      note: 'Pięć największych pozycji to {share} portfela. Powyżej 40% jedna zła wiadomość rusza cały portfel.',
    },
    rebalance: {
      title: 'Rebalans',
      subtitle: 'model i odchylenia',
      pickModel: 'Wybierz model docelowy',
      deviation: 'odchylenie',
      withinTolerance: 'w tolerancji',
      buy: 'Kup',
      sell: 'Sprzedaj',
    },
    models: {
      own: 'Własny',
      balanced: '60/40',
      global: 'Globalny 80/20',
      retirement: 'IKE emerytalne',
    },
    contributions: {
      title: 'Tylko nowymi wpłatami',
      toggle: 'Dosypuj bez sprzedaży',
      pickAmount: 'Wybierz kwotę wpłaty',
      off: 'Włącz, żeby doważać wyłącznie nową wpłatą — wtedy nic nie jest sprzedawane.',
      on: 'Przy wpłacie {amount} dosypujemy tam, gdzie brakuje najwięcej — bez sprzedaży, więc bez podatku i prowizji od zamknięcia.',
    },
    orders: {
      title: 'Zlecenia',
      note: 'Prototyp nie składa zleceń — to lista do przepisania u brokera.',
      empty: 'Nic do zrobienia — wszystkie klasy mieszczą się w tolerancji.',
      units: '{count} szt.',
    },
    instrumentTargets: {
      title: 'Cele na instrument',
      subtitle: 'w obrębie akcji i ETF-ów',
      symbol: 'Symbol',
      now: 'Teraz',
      target: 'Cel',
      deviation: 'Odchyl.',
    ...
    labels: {
      ...
      poland: 'Polska',
      usa: 'USA',
      indexEtf: 'ETF-y indeksowe',
      govBonds: 'Obligacje skarbowe',
