...
export const en: Dictionary = {
  ...
  allocation: {
    ...
    composition: { title: 'Allocation', subtitle: 'share of value' },
    dimensions: {
      class: 'Asset class',
      currency: 'Currency',
      account: 'Account',
    ...
    pickDimension: 'Choose a breakdown dimension',
    concentration: {
      title: 'Concentration',
      subtitle: 'five largest positions',
      note: 'The five largest positions are {share} of the portfolio. Above 40%, one bad headline moves the whole portfolio.',
    },
    rebalance: {
      title: 'Rebalancing',
      subtitle: 'model and deviations',
      pickModel: 'Choose a target model',
      deviation: 'deviation',
    ...
    models: {
      ...
      balanced: '60/40',
      global: 'Global 80/20',
      retirement: 'IKE retirement',
    },
    contributions: {
      title: 'New contributions only',
      toggle: 'Top up without selling',
      pickAmount: 'Choose a contribution amount',
      off: 'Turn on to rebalance with new money only — then nothing is sold.',
      on: 'With a {amount} contribution we top up where the gap is largest — no selling, so no tax and no closing commission.',
    },
    orders: {
      title: 'Orders',
      note: 'The prototype places no orders — this is a list to re-enter with your broker.',
      empty: 'Nothing to do — every class is within tolerance.',
      units: '{count} units',
    },
    instrumentTargets: {
      title: 'Per-instrument targets',
      subtitle: 'within equities and ETFs',
      symbol: 'Symbol',
      now: 'Now',
      target: 'Target',
      deviation: 'Dev.',
